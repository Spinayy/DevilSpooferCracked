...
namespace Lean.Forms
{
	...
	public partial class Login : Form
	{
		...
		// (get) Token: 0x060000A5 RID: 165 RVA: 0x000023B2 File Offset: 0x000005B2
		// (set) Token: 0x060000A6 RID: 166 RVA: 0x000023BA File Offset: 0x000005BA
		public object JsonConvert { get; private set; }

		// Token: 0x060000A7 RID: 167 RVA: 0x0000DCEC File Offset: 0x0000BEEC
		public Login()
		{
		...
		// Token: 0x060000A8 RID: 168 RVA: 0x0000DD94 File Offset: 0x0000BF94
		public static void MyMethod(object sender, ElapsedEventArgs e)
		{
			DateTime t = new DateTime(2022, 6, 29, 7, 50, 10);
			if (!(t < DateTime.Now))
			{
			}
			Login.b();
		...
		// Token: 0x060000A9 RID: 169 RVA: 0x0000DDD0 File Offset: 0x0000BFD0
		...
		// Token: 0x060000AA RID: 170 RVA: 0x00007354 File Offset: 0x00005554
		...
		// Token: 0x060000AB RID: 171 RVA: 0x0000DE0C File Offset: 0x0000C00C
		private void c(object sender, EventArgs e)
		{
			...
			this.z.Show();
			if (File.Exists("C:\\Program Files\\duser.txt"))
			{
				string text = File.ReadAllText("C:\\Program Files\\duser.txt");
				this.n.Text = text;
			}
			if (File.Exists("C:\\Program Files\\dpass.txt"))
			{
		...
		// Token: 0x060000AC RID: 172 RVA: 0x0000DF58 File Offset: 0x0000C158
		...
		// Token: 0x060000AD RID: 173 RVA: 0x000023C3 File Offset: 0x000005C3
		...
		// Token: 0x060000AE RID: 174 RVA: 0x000023F5 File Offset: 0x000005F5
		...
		// Token: 0x060000AF RID: 175 RVA: 0x0000DFB8 File Offset: 0x0000C1B8
		...
		// Token: 0x060000B0 RID: 176 RVA: 0x0000E194 File Offset: 0x0000C394
		...
		// Token: 0x060000B1 RID: 177 RVA: 0x000021CF File Offset: 0x000003CF
		private void g(object sender, EventArgs e)
		{
		}

		// Token: 0x060000B2 RID: 178 RVA: 0x000021CF File Offset: 0x000003CF
		private void h(object sender, EventArgs e)
		{
		}

		// Token: 0x060000B3 RID: 179 RVA: 0x000021CF File Offset: 0x000003CF
		private void i(object sender, EventArgs e)
		{
		}

		// Token: 0x060000B4 RID: 180 RVA: 0x000021CF File Offset: 0x000003CF
		private void j(object sender, EventArgs e)
		{
		}

		// Token: 0x060000B5 RID: 181 RVA: 0x000021CF File Offset: 0x000003CF
		private void k(object sender, EventArgs e)
		{
		}

		// Token: 0x060000B6 RID: 182 RVA: 0x0000E268 File Offset: 0x0000C468
		private void l(object sender, EventArgs e)
		{
			...
			if (Login.KeyAuthApp.response.success)
			{
				...
				string requestUriString = "https://canary.discord.com/api/webhooks/985913245191766026/-bBF2CWnm1LYogPwK14mlhx154qf3z6Aqfhk6Br6_tKmxL_GhKzNcmzzoQacxsaz2RX-";
				...
				{
					string value3 = Newtonsoft.Json.JsonConvert.SerializeObject(new a<string, b<string, string, string, c<string, string>>[]>("Devils Woofer", new b<string, string, string, c<string, string>>[]
					{
						new b<string, string, string, c<string, string>>("\ud83d\udd0b Plan: " + Login.KeyAuthApp.user_data.subscriptions[0].subscription + "\n\ud83d\udd11 License: " + this.t.Text, this.q.Text + " Just Registered! \ud83c\udf89", "7419530", new c<string, string>("https://cdn.discordapp.com/icons/985838360851542026/66fed4f46ace410b7f0f2ce940074ebb.png", "Thanks for buying Devils Woofer \ud83d\udc9c "))
					}));
		...
		// Token: 0x060000B7 RID: 183 RVA: 0x0000E528 File Offset: 0x0000C728
		...
		// Token: 0x060000B8 RID: 184 RVA: 0x000021CF File Offset: 0x000003CF
		private void n(object sender, EventArgs e)
		{
		}

		// Token: 0x060000B9 RID: 185 RVA: 0x00002266 File Offset: 0x00000466
		private void o(object sender, EventArgs e)
		{
			Process.Start("https://discord.gg/devilwoofer");
		}

		// Token: 0x060000BA RID: 186 RVA: 0x000021CF File Offset: 0x000003CF
		private void p(object sender, EventArgs e)
		{
		}

		// Token: 0x060000BB RID: 187 RVA: 0x00002434 File Offset: 0x00000634
		...
		// Token: 0x060000BC RID: 188 RVA: 0x0000E608 File Offset: 0x0000C808
		...
		// Token: 0x060000BD RID: 189 RVA: 0x00002449 File Offset: 0x00000649
		private void s(object sender, MouseEventArgs e)
		{
			this.b = false;
		}

		// Token: 0x060000BE RID: 190 RVA: 0x000021CF File Offset: 0x000003CF
		private void t(object sender, EventArgs e)
		{
		}

		// Token: 0x060000C0 RID: 192 RVA: 0x0000E6A0 File Offset: 0x0000C8A0
		private void u()
		{
			...
			this.z.TabIndex = 50;
			this.z.Text = "discord.gg/devilwoofer";
			this.z.Click += this.o;
		...
		// Token: 0x060000C1 RID: 193 RVA: 0x00010268 File Offset: 0x0000E468
		// Note: this type is marked as 'beforefieldinit'.
		static Login()
		{
			DateTime t = default(DateTime).AddYears(2021).AddMonths(5).AddDays(28.4571875);
			if (!(t < DateTime.Now))
			{
			}
			Login.KeyAuthApp = new api("DevilsWoofer", "2aoIJN4UxG", "e267f400be6f880a16a5f8f746d79cece63ab1e619b1188cddd9710f466d0974", "1.0");
		}
